...
Elm.Main.make = function (_elm) {
   ...
   var leafUnderPtr = function (layout) {
      return function () {
         var go = F2(function (layout,
         _v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
         ...
         A2($Signal._op["<~"],go,layout),
         $Mouse.position);
      }();
   };
   var layout = F3(function (availableWidth,
   pixelsPerInch,
   term) {
      return A2($Unison$View.layout,
      term,
      {_: {}
      ,availableWidth: availableWidth
      ,metadata: function (h) {
         return $Unison$Metadata.anonymousTerm;
      }
      ,overrides: function (x) {
         return $Maybe.Nothing;
      }
      ,pixelsPerInch: pixelsPerInch
      ,rootMetadata: $Unison$Metadata.anonymousTerm});
   });
   var resolvedPath = F2(function (e,
   pathUnderPtr) {
      return function () {
         var defaultScope = A2($Signal.lift,
         $Maybe.map($Unison$Scope.scope),
         pathUnderPtr);
         var edit = F2(function (_v9,e) {
            return function () {
               return function ($) {
                  return (_U.eq(_v9.x,
                  -1) ? $Unison$Scope.left(e) : $Basics.identity)((_U.eq(_v9.x,
                  1) ? $Unison$Scope.right(e) : $Basics.identity)((_U.eq(_v9.y,
                  -1) ? $Unison$Scope.down(e) : $Basics.identity)((_U.eq(_v9.y,
                  1) ? $Unison$Scope.up : $Basics.identity)($))));
               };
            }();
         });
         var nonzero = function (_v11) {
            return function () {
               return !_U.eq(_v11.x,
               0) || !_U.eq(_v11.y,0);
            }();
         };
         var edits = A2($Signal._op["~"],
         A2($Signal._op["<~"],
         edit,
         A4($Elmz$Signal.repeatAfterIf,
         300 * $Time.millisecond,
         20,
         nonzero,
         $Keyboard.arrows)),
         e);
         var shifted = A4($Elmz$Signal.foldpBetween$,
         $Mouse.position,
         F2(function (edit,p) {
            return A2($Maybe.map,edit,p);
         }),
         defaultScope,
         edits);
         return A2($Elmz$Signal.fromMaybe,
         defaultScope,
         shifted);
      }();
   });
   var full = $Unison$Term.Lit($Unison$Term.Relative($Elmz$Distance.full));
   var string = function (s) {
      return $Unison$Term.Lit($Unison$Term.Str(s));
   };
   var vec = function (es) {
   ...
   builtin("View.swatch")),
   A3(rgbTerm,230,126,34))));
   var terms = $Signal.constant(expr);
   ...
   var h1 = function (s) {
      ...
      $Unison$Term.Lit($Unison$Term.Str(s)));
   };
   var body = function (s) {
      return A2(cell,
      text($Unison$Term.Blank),
   ...
   var pixelsPerInch = $Native$Ports.portIn("pixelsPerInch",
   $Native$Ports.incomingSignal(function (v) {
      return typeof v === "number" ? v : _E.raise("invalid input, expecting JSNumber but got " + v);
   }));
   var main = function () {
      var scene = F4(function (l,
      selection,
      scope,
      ppi) {
         return A2($Graphics$Element.flow,
         $Graphics$Element.down,
         _L.fromArray([$Graphics$Element.layers(_L.fromArray([$Elmz$Layout.element(l)
                                                             ,selection]))
                      ,A2($Graphics$Element.spacer,
                      1,
                      100)
                      ,$Unison$Styles.codeText(_L.append("pixels per inch: ",
                      $String.show(ppi)))
                      ,$Unison$Styles.codeText(_L.append("Path: ",
                      $String.show(A2($Maybe.map,
                      function (_) {
                         return _.focus;
                      },
                      scope))))]));
      ...
      var terms = $Signal.constant(expr);
      var rendered = A2($Signal._op["~"],
      A2($Signal._op["~"],
      A2($Signal._op["<~"],
      layout,
      A2($Elmz$Signal.steady,
      100 * $Time.millisecond,
      $Window.width)),
      pixelsPerInch),
      terms);
      var leaf = A2($Signal.lift,
      $Maybe.map(function (_) {
         return _.path;
      }),
      leafUnderPtr(rendered));
      var scope = A2(resolvedPath,
      terms,
      leaf);
      var highlight = function () {
         var region = F2(function (layout,
         scope) {
            return function () {
               switch (scope.ctor)
               {case "Just":
      ...
      var highlightLayer = function () {
         var f = F2(function (layout,
         region) {
            return function () {
               switch (region.ctor)
               {case "Just":
                  return A2($Unison$Styles.selection,
                    layout,
                    region._0);
                  case "Nothing":
...
Elm.Unison.View.make = function (_elm) {
            ...
            {case "App":
               switch (expr._0.ctor)
                 {case "App":
                    return function () {
                         var sym = function () {
                            switch (expr._0._0.ctor)
                            {case "Ref":
                               return A2($Unison$Metadata.firstSymbol,
                                 $Unison$Reference.toString(expr._0._0._0),
                                 md(expr._0._0._0));
                               case "Var":
                               return A3($Unison$Metadata.resolveLocal,
                                 rootMd,
                                 path,
                                 expr._0._0._0);}
                            return $Unison$Metadata.anonymousSymbol;
                         }();
                         return function () {
                            var _v29 = sym.fixity;
                            switch (_v29.ctor)
               ...
               case "Vector":
               return Bracketed($Array.toList($Array.indexedMap(F2(function (i,
                 a) {
                    return {_: {}
                           ,path: A2($Unison$Path.snoc,
                           path,
   ...
   cur) {
      return function () {
                                                                       ...
                                                                       switch (e._0.ctor)
                                                                         {case "Str":
                                                                            return function () {
                                                                                 ...
                                                                                 availableWidth,
                                                                                 A3($Elmz$Distance.relativePixels,
                                                                                 v._0._1._0._0,
                                                                                 availableWidth,
                                                                                 env.pixelsPerInch));
                                                                                 var f = function () {
                                                                                    ...
                                                                                    {case "Text.center":
                                                                                       ...
                                                                                       case "Text.left":
                                                                                       return $Text.leftAligned;
                                                                                       case "Text.right":
                                                                                       return $Text.rightAligned;}
                                                                                    _E.Case($moduleName,
                                                ...
                                                switch (v._1.ctor)
                                                  {case "Lit":
                                                     switch (v._1._0.ctor)
                                                       {case "Absolute":
                                                          return function () {
                                                               var h$ = A2($Elmz$Distance.absolutePixels,
                                                               v._1._0._0,
                                                               env.pixelsPerInch);
                                                               var w$ = A2($Basics.min,
                                                               availableWidth,
                                                                                                          ...
                                                                                                          switch (v._1._1._0.ctor)
                                                                                                            {case "Number":
                                                                                                               return function () {
                                                                                                                    ...
                                                                                                                    v._1._1._0._0);
                                                                                                                    return $Maybe.Just(A2($Elmz$Layout.fill,
                                                                                                                    c$,
                                                                                                                    A5(impl,
                                                                                                                    env,
                                                                                                                    allowBreak,
                                 ...
                                 return function () {
                                      ...
                                      {case "Lit": switch (e._0.ctor)
                                           {case "Str":
                                              return $Maybe.Just(A2($Elmz$Layout.embed,
                                                t,
                                                $Text.leftAligned(A2($Text.style,
                                                $Text.defaultStyle,
                                                $Text.toText(e._0._0)))));}
                                           break;}
                                      _E.Case($moduleName,
         ...
         return function () {
            ...
            switch (_v112.ctor)
            {case "App":
               switch (_v112._0.ctor)
                 {case "App":
                    switch (_v112._0._0.ctor)
                      {case "App":
                         switch (_v112._0._0._0.ctor)
                           {case "Ref":
                              switch (_v112._0._0._0._0.ctor)
                                {case "Builtin":
                                   switch (_v112._0._0._0._0._0)
                                     {case "View.cell":
                                        switch (_v112._0._0._1.ctor)
                                          {case "App":
                                             switch (_v112._0._0._1._0.ctor)
                                               {case "Ref":
                                                  switch (_v112._0._0._1._0._0.ctor)
                                                    {case "Builtin":
                                                       switch (_v112._0._0._1._0._0._0)
                                                         {case "View.function1":
                                                            switch (_v112._0._0._1._1.ctor)
                                                              {case "Lam":
                                                                 return function () {
                                                                      ...
                                                                      var g = function (view) {
                                                                         ...
                                                                         {_: {}
                                                                         ,path: fpath
                                                                         ,term: A3($Unison$Term.substitute,
                                                                         _v112._0._0._1._1._1,
                                                                         _v112._0._0._1._1._0,
                                                                         view)}));
                                                                      };
                                                                      var eview = $Unison$Term.close($Unison$Term.Embed(A5(impl,
                                                                      env,
                                                                      allowBreak,
                                                                      0,
                                                                      availableWidth,
                         ...
                         switch (_v112._0._0._0.ctor)
                           {case "Builtin":
                              switch (_v112._0._0._0._0)
                                {case "View.cell": return A2(go,
                                     _v112._0._1,
                                     _v112._1);
                                   case "View.panel": return A2(go,
                                     _v112._0._1,
                                     _v112._1);}
                                break;}
                           break;}
   ...
   cur) {
      return function () {
         var _v129 = env.overrides(cur.path);
         switch (_v129.ctor)
         {case "Just": return _v129._0;
            case "Nothing":
            return function () {
                 var _v131 = cur.term;
                 switch (_v131.ctor)
                 {case "Blank":
                    ...
                    case "Embed": return _v131._0;
                    case "Lit":
                    switch (_v131._0.ctor)
                      {case "Number":
                         return $Elmz$Layout.embed(tag(cur.path))($Unison$Styles.numericLiteral($String.show(_v131._0._0)));
                         case "Str":
                         return $Elmz$Layout.embed(tag(cur.path))($Unison$Styles.stringLiteral(_L.append("\"",
                           _L.append(_v131._0._0,"\""))));}
                      break;
                    case "Ref":
                    return $Elmz$Layout.embed(tag(cur.path))($Unison$Styles.codeText(A2($Unison$Metadata.firstName,
                      $Unison$Reference.toString(_v131._0),
                      env.metadata(_v131._0))));
                    case "Var":
                    return $Elmz$Layout.embed(tag(cur.path))($Unison$Styles.codeText(A3($Unison$Metadata.resolveLocal,
                      env.rootMetadata,
                      cur.path,
                      _v131._0).name));}
                 return function () {
                    var _v138 = A5(builtins,
                    env,
                    allowBreak,
                    ambientPrec,
                    availableWidth,
                            ...
                            return function () {
                               ...
                               {case "Bracketed":
                                  return function () {
                                       ...
                                       availableWidth) < 0 || _U.cmp($List.length(_v140._0),
                                  ...
                                  case "Lambda":
                                  return function () {
                                       var argLayout = $Elmz$Layout.intersperseHorizontal(space$)(_L.append(A2($List.map,
                                       A4(impl,env,false,0,0),
                                       _v140._0),
                                       _L.fromArray([A2($Elmz$Layout.embed,
                                       tag(cur.path),
                                       $Unison$Styles.codeText("→"))])));
                                  ...
                                  case "Operators":
                                  return function () {
                                       var rprec = _v140._0 ? 1 + _v140._1 : _v140._1;
                                       var bf = F2(function (_v150,l) {
                                          return function () {
                                             switch (_v150.ctor)
                                             {case "_Tuple2":
                                                return function () {
                                       ...
                                       var lprec = _v140._0 ? _v140._1 : 1 + _v140._1;
                                       var f = F2(function (_v154,l) {
                                          return function () {
                                             switch (_v154.ctor)
                                             {case "_Tuple2":
                               ...
                               _E.Case($moduleName,
                               "between lines 139 and 182");
                            }();
                         }();}
                    _E.Case($moduleName,
                    "between lines 136 and 182");
                 }();
              }();}
         _E.Case($moduleName,
      ...
      return function () {
         return function () {
            ...
            {case "::": return A3(Scope,
                 ...
                 _v0.downs));
               case "[]": return function () {
                    var f = $Unison$Term.up(_v0.focus);
                    return _U.eq(f,
                    _v0.focus) ? A3(Scope,
                    _v0.focus,
                    _v0.ups,
...
Elm.Unison.Node.make = function (_elm) {
   ...
   $Unison$Var = Elm.Unison.Var.make(_elm);
   var $undefined = $undefined;
   var decodeResponse = F2(function (p,
   r) {
      return function () {
         switch (r.ctor)
         {case "Failure":
            return A2($Http.Failure,
              r._0,
              r._1);
            case "Success":
            return function () {
                 var err = $Either.Left(_L.append("malformed json: ",
                 r._0));
                 return function () {
                    var _v4 = A3($Maybe.maybe,
                    err,
                    $Elmz$Json$Decoder.run(p),
                    $Json.fromString(r._0));
                    switch (_v4.ctor)
                    {case "Left":
                       return A2($Http.Failure,
                         0,
   ...
   var jsonRequest = F5(function (verb,
   ja,
   host,
   path,
   a) {
   ...
   var jsonPost = jsonRequest("POST");
   var createTerm = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Unison$Term.encodeTerm,
         $Unison$Metadata.encodeMetadata);
         var req = F2(function (host,
         params) {
            return A4(jsonPost,
            body,
            host,
         ...
         return A2($Signal._op["<~"],
         decodeResponse($Unison$Hash.decode),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
      }();
   });
   var createType = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
   ...
   var updateMetadata = F2(function (host,
   params) {
      return function () {
         var decode = decodeResponse($Elmz$Json$Decoder.unit({ctor: "_Tuple0"}));
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Unison$Hash.encode,
         $Unison$Metadata.encodeMetadata);
         var req = F2(function (host,
   ...
   var jsonGet = jsonRequest("GET");
   var admissibleTypeOf = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Unison$Term.encodeTerm,
         ...
         return A2($Signal._op["<~"],
         decodeResponse($Unison$Type.decodeType),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
   ...
   var dependencies = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Elmz$Json$Encoder.optional($Elmz$Json$Encoder.set($Unison$Hash.encode)),
         $Unison$Hash.encode);
         var req = F2(function (host,
         params) {
            return A4(jsonGet,
         ...
         return A2($Signal._op["<~"],
         decodeResponse($Elmz$Json$Decoder.set($Unison$Hash.decode)),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
   ...
   var dependents = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Elmz$Json$Encoder.optional($Elmz$Json$Encoder.set($Unison$Hash.encode)),
   ...
   var editTerm = F2(function (host,
   params) {
      return function () {
         var decode = decodeResponse($Unison$Term.decodeTerm);
         var body = A3($Elmz$Json$Encoder.tuple3,
         $Unison$Path.encodePath,
   ...
   var metadatas = F2(function (host,
   params) {
      return function () {
         var req = F2(function (host,
         params) {
            return A4(jsonGet,
            $Elmz$Json$Encoder.array($Unison$Hash.encode),
            host,
            "metadata",
            params);
         });
         return A2($Signal._op["<~"],
         decodeResponse($Elmz$Json$Decoder.object($Unison$Metadata.decodeMetadata)),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
   ...
   var search = F2(function (host,
   params) {
      return function () {
         var decode = decodeResponse($Elmz$Json$Decoder.object($Unison$Metadata.decodeMetadata));
         var body = A3($Elmz$Json$Encoder.tuple3,
   ...
   var searchLocal = F2(function (host,
   params) {
      return function () {
         var decode = A2($Elmz$Json$Decoder.tuple2,
         $Unison$Metadata.decodeMetadata,
         $Elmz$Json$Decoder.array(A2($Elmz$Json$Decoder.tuple2,
         $Unison$Var.decode,
         $Unison$Type.decodeType)));
         var body = A4($Elmz$Json$Encoder.tuple4,
         $Unison$Hash.encode,
         $Unison$Path.encodePath,
         $Elmz$Json$Encoder.optional($Unison$Type.encodeType),
         $Unison$Metadata.encodeQuery);
   ...
   params) {
      return function () {
         ...
         return A2($Signal._op["<~"],
         decodeResponse($Elmz$Json$Decoder.object($Unison$Term.decodeTerm)),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
   ...
   var transitiveDependencies = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Elmz$Json$Encoder.optional($Elmz$Json$Encoder.set($Unison$Hash.encode)),
   ...
   var transitiveDependents = F2(function (host,
   params) {
      return function () {
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Elmz$Json$Encoder.optional($Elmz$Json$Encoder.set($Unison$Hash.encode)),
   ...
   var types = F2(function (host,
   params) {
      return function () {
         var body = $Elmz$Json$Encoder.array($Unison$Hash.encode);
         var req = F2(function (host,
         params) {
            return A4(jsonGet,
            body,
         ...
         return A2($Signal._op["<~"],
         decodeResponse($Elmz$Json$Decoder.object($Unison$Type.decodeType)),
         $Http.send(A3($Signal.lift2,
         req,
         host,
         params)));
   ...
   var typeOf = F2(function (host,
   params) {
      return function () {
         var decode = decodeResponse($Unison$Type.decodeType);
         var body = A2($Elmz$Json$Encoder.tuple2,
         $Unison$Term.encodeTerm,
         $Unison$Path.encodePath);
         var req = F2(function (host,
      ...
      return function () {
         ...
         {case "Abstract":
            ...
            return A3($Elmz$Json$Encoder.tag$,
              ...
              {ctor: "_Tuple0"});}
         _E.Case($moduleName,
         "between lines 19 and 25");
      }();
   };
   var Apply = function (a) {
      return {ctor: "Apply",_0: a};
   };
   var WHNF = {ctor: "WHNF"};
   var LetFloat = {ctor: "LetFloat"};
   var Eta = {ctor: "Eta"};
   var Beta = {ctor: "Beta"};
...
Elm.Unison.Term.make = function (_elm) {
   ...
   var encodeAbsolute = function (_v10) {
      return function () {
         switch (_v10.ctor)
         {case "Absolute":
            return A3($Elmz$Json$Encoder.tag$,
              ...
              _v10._0);}
         _E.Case($moduleName,
         "on line 191, column 40 to 104");
      }();
   };
   var encodeRelative = function (d) {
      return function () {
         switch (d.ctor)
         {case "Embed":
            return A3($Elmz$Json$Encoder.tag$,
              "Embed",
              encodeD(encodeRelative),
              d._0);
            case "Fraction":
            return A3($Elmz$Json$Encoder.tag$,
              "Fraction",
   ...
   var encodeTerm = function (e) {
      return function () {
         ...
         {case "Ann":
            ...
            return A3($Elmz$Json$Encoder.tag$,
              "App",
              $Elmz$Json$Encoder.array(encodeTerm),
   ...
   var decodeD = function (d) {
      return $Elmz$Json$Decoder.union$(function (t) {
         return _U.eq(t,
         "Quantum") ? $Elmz$Json$Decoder.unit($Elmz$Distance.Quantum) : _U.eq(t,
         "Centimeters") ? A2($Elmz$Json$Decoder.map,
         $Elmz$Distance.Centimeters,
         $Elmz$Json$Decoder.number) : _U.eq(t,
         "Scale") ? A3($Elmz$Json$Decoder.lift2,
         $Elmz$Distance.Scale,
         $Elmz$Json$Decoder.number,
         d) : _U.eq(t,
         ...
         $Elmz$Distance.Floor,
         d) : _U.eq(t,
         "Min") ? A3($Elmz$Json$Decoder.lift2,
         $Elmz$Distance.Min,
         d,
         d) : _U.eq(t,
         "Max") ? A3($Elmz$Json$Decoder.lift2,
         $Elmz$Distance.Max,
         d,
         d) : _E.If($moduleName,
   ...
   var decodeAbsolute = A2($Elmz$Json$Decoder.newtyped$,
   $Elmz$Distance.Absolute,
   decodeD(function (j) {
      return decodeAbsolute(j);
   }));
   var decodeRelative = $Elmz$Json$Decoder.union$(function (t) {
      return _U.eq(t,
      "Fraction") ? A2($Elmz$Json$Decoder.map,
      $Elmz$Distance.Fraction,
      $Elmz$Json$Decoder.number) : _U.eq(t,
      "Embed") ? A2($Elmz$Json$Decoder.map,
      $Elmz$Distance.Embed,
      decodeD(decodeRelative)) : _E.If($moduleName,
            ...
            switch (_v37._0.ctor)
              {case "::":
                 switch (_v37._0._0.ctor)
                   ...
                   break;
                 case "[]":
                 return $Maybe.Just(_v37._1);}
              break;}
         return $Maybe.Nothing;
      }();
   });
   var valid = F2(function (e,p) {
      return $Maybe.isJust(A2(at,
      p,
      e));
   });
      ...
      return function () {
         ...
         {case "Ann":
            ...
            return A2($Set.remove,
              e._0,
              unbound(e._1));
            case "Lit": return $Set.empty;
            case "Var":
            return $Set.singleton(e._0);
            case "Vector":
            return A2($Array.foldl,
              $Set.union,
              $Set.empty)(A2($Array.map,
              unbound,
              e._0));}
         return $Set.empty;
      }();
   ...
   var fresh = function (e) {
      return function () {
         switch (e.ctor)
         {case "Ann": return fresh(e._0);
            case "App":
            return A2($Basics.max,
              fresh(e._0),
              fresh(e._1));
            case "Lam":
            return $Unison$Var.succ(e._0);
            case "Lit":
            return $Unison$Var.z;
            case "Vector":
            return A2($Array.foldl,
              $Basics.max,
              $Unison$Var.z)(A2($Array.map,
              fresh,
              e._0));}
         return $Unison$Var.z;
      }();
   };
   var unclose = function (_v80) {
      return function () {
         switch (_v80.ctor)
         {case "ClosedTerm":
            return _v80._0;}
         _E.Case($moduleName,
         "on line 56, column 26 to 27");
      }();
   };
   ...
   var close = function (e) {
      return _U.eq(unbound(e),
      $Set.empty) ? $Maybe.Just(ClosedTerm(e)) : $Maybe.Nothing;
   };
   ...
   var rename = F3(function (from,
   to,
   e) {
      return function () {
         switch (e.ctor)
         {case "Ann": return A2(Ann,
              A3(rename,from,to,e._0),
              e._1);
            case "App": return A2(App,
              A3(rename,from,to,e._0),
              A3(rename,from,to,e._1));
            case "Lam": return A2(Lam,
              e._0,
              A3(rename,from,to,e._1));
            case "Lit": return e;
            case "Var": return _U.eq(e._0,
              from) ? Var(to) : e;
            case "Vector":
   ...
   var substitute = F3(function (body,
   v,
   x) {
      return function () {
         var freshx = fresh(unclose(x));
         var go = function (body) {
            return function () {
               switch (body.ctor)
               {case "Ann": return A2(Ann,
                    A3(substitute,body._0,v,x),
                    body._1);
                  case "App": return A2(App,
                    A3(substitute,body._0,v,x),
                    A3(substitute,body._1,v,x));
                  case "Lam":
   ...
   var decodeLiteral = $Elmz$Json$Decoder.union$(function (t) {
      ...
      Number,
      $Elmz$Json$Decoder.number) : _U.eq(t,
      "String") ? A2($Elmz$Json$Decoder.map,
      Str,
      $Elmz$Json$Decoder.string) : _U.eq(t,
      "Relative") ? A2($Elmz$Json$Decoder.map,
      Relative,
      decodeRelative) : _U.eq(t,
      "Absolute") ? A2($Elmz$Json$Decoder.map,
      Absolute,
      decodeAbsolute) : _E.If($moduleName,
      "between lines 200 and 203");
   });
   var decodeTerm = $Elmz$Json$Decoder.union$(function (t) {
      return _U.eq(t,
      "Var") ? A2($Elmz$Json$Decoder.map,
      Var,
      $Unison$Var.decode) : _U.eq(t,
      "Lit") ? A2($Elmz$Json$Decoder.map,
      Lit,
      decodeLiteral) : _U.eq(t,
      "Vector") ? A2($Elmz$Json$Decoder.map,
      function ($) {
         return Vector($Array.fromList($));
      },
      $Elmz$Json$Decoder.array(decodeTerm)) : _U.eq(t,
      "Ref") ? A2($Elmz$Json$Decoder.map,
      Ref,
      $Unison$Reference.decode) : _U.eq(t,
      "App") ? A3($Elmz$Json$Decoder.lift2,
      App,
      decodeTerm,
      decodeTerm) : _U.eq(t,
      "Ann") ? A3($Elmz$Json$Decoder.lift2,
      Ann,
      decodeTerm,
      $Unison$Type.decodeType) : _U.eq(t,
      "Lam") ? A3($Elmz$Json$Decoder.lift2,
      Lam,
      $Unison$Var.decode,
      decodeTerm) : _U.eq(t,
      "Blank") ? $Elmz$Json$Decoder.unit(Blank) : _E.If($moduleName,
   ...
   _elm.Unison.Term.values = {_op: _op
                             ...
                             ,decodeD: decodeD
                             ,encodeD: encodeD
                             ,decodeAbsolute: decodeAbsolute
                             ,decodeRelative: decodeRelative
                             ,encodeAbsolute: encodeAbsolute
                             ,encodeRelative: encodeRelative
...
Elm.Elmz.Distance.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm);
   var absoluteCentimeters = F2(function (_v0,
   quantum) {
      return function () {
         switch (_v0.ctor)
         {case "Absolute":
            return function () {
                 switch (_v0._0.ctor)
                 {case "Ceiling":
                    return $Basics.toFloat($Basics.ceiling(A2(absoluteCentimeters,
                      _v0._0._0,
                      quantum) / quantum)) * quantum;
                    case "Centimeters":
                    return _v0._0._0;
                    case "Floor":
                    return $Basics.toFloat($Basics.floor(A2(absoluteCentimeters,
                      _v0._0._0,
                      quantum) / quantum)) * quantum;
                    case "Max":
                    return A2($Basics.max,
                      A2(absoluteCentimeters,
                      _v0._0._0,
                      quantum),
                      A2(absoluteCentimeters,
                      _v0._0._1,
                    ...
                    case "Scale":
                    return _v0._0._0 * A2(absoluteCentimeters,
                      _v0._0._1,
                      quantum);}
                 _E.Case($moduleName,
   ...
   var absolutePixels = F2(function (d,
   pixelsPerInch) {
      return function () {
         var pixelsPerCm = $Basics.toFloat(pixelsPerInch) / 2.54;
         return $Basics.ceiling(A2(absoluteCentimeters,
         d,
         1.0 / pixelsPerCm));
      }();
   });
   var centimeters = F3(function (d,
   quantum,
   dmax) {
      return function () {
         switch (d.ctor)
         {case "Embed":
            return function () {
                 switch (d._0.ctor)
                 {case "Ceiling":
                    return $Basics.toFloat($Basics.ceiling(A3(centimeters,
                      d._0._0,
                      quantum,
                      dmax) / quantum)) * quantum;
                    case "Centimeters":
                    return d._0._0;
                    case "Floor":
                    return $Basics.toFloat($Basics.floor(A3(centimeters,
                      d._0._0,
                      quantum,
                      dmax) / quantum)) * quantum;
                    case "Max":
                    ...
                    case "Quantum": return quantum;
                    case "Scale":
                    return d._0._0 * A3(centimeters,
                      d._0._1,
                      quantum,
                      dmax);}
                 _E.Case($moduleName,
                 "between lines 31 and 41");
              }();
            case "Fraction":
            return dmax * d._0;}
         _E.Case($moduleName,
         "between lines 29 and 41");
      }();
   });
   var relativePixels = F3(function (d,
   availablePixels,
   pixelsPerInch) {
      return function () {
         var widthInInches = $Basics.toFloat(availablePixels) / $Basics.toFloat(pixelsPerInch);
         var widthInCm = widthInInches * 2.54;
         var pixelCm = widthInCm / $Basics.toFloat(availablePixels);
         var cm = A3(centimeters,
         d,
         pixelCm,
         widthInCm);
         return $Basics.ceiling(cm / pixelCm);
      }();
   });
   var Absolute = function (a) {
      return {ctor: "Absolute"
   ...
   var Centimeters = function (a) {
      return {ctor: "Centimeters"
             ,_0: a};
   };
   var Quantum = {ctor: "Quantum"};
   _elm.Elmz.Distance.values = {_op: _op
                               ...
                               ,half: half
                               ,centimeters: centimeters
                               ,relativePixels: relativePixels
                               ,absoluteCentimeters: absoluteCentimeters
...
Elm.Unison.Type.make = function (_elm) {
   ...
   var encodeKind = function (k) {
      return function () {
         ...
         {case "KArrow":
            return A3($Elmz$Json$Encoder.tag$,
              "Arrow",
              $Elmz$Json$Encoder.array(encodeKind),
   ...
   var encodeType = function (t) {
      return function () {
         ...
         {case "Ann":
            ...
            return A3($Elmz$Json$Encoder.tag$,
              "Arrow",
              $Elmz$Json$Encoder.array(encodeType),
   ...
   var decodeKind = $Elmz$Json$Decoder.union$(function (t) {
      ...
      "Arrow") ? A3($Elmz$Json$Decoder.lift2,
      KArrow,
      decodeKind,
      decodeKind) : _E.If($moduleName,
   ...
   var decodeLiteral = $Elmz$Json$Decoder.union$(function (t) {
      ...
      "String") ? $Elmz$Json$Decoder.unit(String) : _U.eq(t,
      "Vector") ? $Elmz$Json$Decoder.unit(Vector) : _U.eq(t,
      "Hash") ? A2($Elmz$Json$Decoder.map,
      Hash,
      $Unison$Hash.decode) : _E.If($moduleName,
      "between lines 35 and 38");
   });
   var decodeType = $Elmz$Json$Decoder.union$(function (t) {
      return _U.eq(t,
      "Unit") ? A2($Elmz$Json$Decoder.map,
      Unit,
      decodeLiteral) : _U.eq(t,
      "Arrow") ? A3($Elmz$Json$Decoder.lift2,
      Arrow,
      decodeType,
      decodeType) : _U.eq(t,
      "Universal") ? A2($Elmz$Json$Decoder.map,
      Universal,
      $Unison$Var.decode) : _U.eq(t,
      "Existential") ? A2($Elmz$Json$Decoder.map,
      Existential,
      $Unison$Var.decode) : _U.eq(t,
      "Kind") ? A3($Elmz$Json$Decoder.lift2,
      Ann,
      decodeType,
      decodeKind) : _U.eq(t,
      "Constrain") ? A3($Elmz$Json$Decoder.lift2,
      Constrain,
      decodeType,
      $Elmz$Json$Decoder.unit({ctor: "_Tuple0"})) : _U.eq(t,
      "Forall") ? A3($Elmz$Json$Decoder.lift2,
      Forall,
      $Unison$Var.decode,
      decodeType) : _E.If($moduleName,
      "between lines 42 and 48");
   });
...
Elm.Unison.Metadata.make = function (_elm) {
   ...
   var encodeNames = A2($Elmz$Json$Encoder.tag$,
   "Names",
   $Elmz$Json$Encoder.array(encodeSymbol));
   var encodeLocals = function (m) {
      return A2($Elmz$Json$Encoder.array,
      A2($Elmz$Json$Encoder.tuple2,
      $Unison$Var.encode,
      $Elmz$Json$Encoder.array(A2($Elmz$Json$Encoder.tuple2,
      $Unison$Path.encodePath,
      encodeNames))),
      $Dict.toList(m));
   };
   var encodeMetadata = function (md) {
      ...
      encodeNames,
      encodeLocals,
      $Elmz$Json$Encoder.optional($Unison$Reference.encode),
      $Unison$Reference.encode),
      {ctor: "_Tuple5"
      ,_0: md.sort
      ,_1: md.names
   ...
   var decodeQuery = A2($Elmz$Json$Decoder.newtyped$,
   Query,
   $Elmz$Json$Decoder.string);
   var Symbol = F3(function (a,
   b,
   c) {
      return {_: {}
             ,fixity: b
   ...
   var decodeFixity = $Elmz$Json$Decoder.bind($Elmz$Json$Decoder.string)(function (t) {
      return _U.eq(t,
      ...
      "Prefix") ? $Elmz$Json$Decoder.unit(Prefix) : $Elmz$Json$Decoder.fail(_L.append("expected {InfixL, InfixR, Infix, Prefix}, got : ",
      t));
   });
   var decodeSymbol = function () {
      ...
      return $Elmz$Json$Decoder.newtyped$($Basics.identity)(A4($Elmz$Json$Decoder.product3,
      symbol,
      $Elmz$Json$Decoder.string,
      decodeFixity,
      $Elmz$Json$Decoder.$int));
   }();
   var decodeNames = A2($Elmz$Json$Decoder.newtyped$,
   $Basics.identity,
   $Elmz$Json$Decoder.array(decodeSymbol));
   var decodeLocals = A2($Elmz$Json$Decoder.map,
   $Dict.fromList,
   $Elmz$Json$Decoder.array(A2($Elmz$Json$Decoder.tuple2,
   $Unison$Var.decode,
   $Elmz$Json$Decoder.array(A2($Elmz$Json$Decoder.tuple2,
   ...
   decodeNames)))));
   var localNames = F3(function (env,
   p,
   v) {
      return function () {
         var trimmed = $Unison$Path.trimToScope(p);
         return function () {
            var _v5 = A2($Dict.get,
            v,
            env.locals);
                       ...
                       return function () {
                          ...
                          {case "_Tuple2":
                             return function () {
                                  switch (acc.ctor)
                                  {case "Just":
                                     return $Maybe.Just(acc._0);
                                     case "Nothing":
                                     return _U.eq(_v7._0,
                                       trimmed) ? $Maybe.Just(_v7._1) : $Maybe.Nothing;}
                                  _E.Case($moduleName,
   ...
   var resolveLocal = F3(function (md,
   p,
   v) {
      return function () {
         var ns = A3(localNames,
         md,
         p,
         v);
         return $List.isEmpty(ns) ? {_: {}
                                    ,fixity: Prefix
                                    ,name: _L.append("v",
                                    $String.show(v))
                                    ,precedence: 9} : $List.head(ns);
      }();
   });
   var firstName = F2(function (ifEmpty,
   md) {
      return $List.isEmpty(md.names) ? ifEmpty : $List.head(md.names).name;
   });
   ...
   var anonymousSymbol = A3(Symbol,
   "anonymousSymbol",
   Prefix,
   9);
   var Metadata = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var Term = {ctor: "Term"};
   var anonymousTerm = A5(Metadata,
   Term,
   _L.fromArray([]),
   $Dict.empty,
   $Maybe.Nothing,
   $Unison$Reference.Builtin("unknown type"));
   var Type = {ctor: "Type"};
   var decodeSort = $Elmz$Json$Decoder.bind($Elmz$Json$Decoder.string)(function (t) {
      return _U.eq(t,
      "Type") ? $Elmz$Json$Decoder.unit(Type) : _U.eq(t,
      "Term") ? $Elmz$Json$Decoder.unit(Term) : $Elmz$Json$Decoder.fail(_L.append("expected {Type, Term}, got : ",
      t));
   });
   var decodeMetadata = $Elmz$Json$Decoder.newtyped$($Basics.identity)(A6($Elmz$Json$Decoder.product5,
   Metadata,
   decodeSort,
   decodeNames,
   decodeLocals,
   $Elmz$Json$Decoder.optional($Unison$Reference.decode),
   $Unison$Reference.decode));
   _elm.Unison.Metadata.values = {_op: _op
                                 ,Type: Type
                                 ,Term: Term
                                 ,Metadata: Metadata
                                 ,anonymousSymbol: anonymousSymbol
                                 ...
                                 ,decodeLocals: decodeLocals
                                 ,encodeLocals: encodeLocals
                                 ,encodeMetadata: encodeMetadata};
   return _elm.Unison.Metadata.values;
};Elm.Unison = Elm.Unison || {};
Elm.Unison.Var = Elm.Unison.Var || {};
Elm.Unison.Var.make = function (_elm) {
   "use strict";
   _elm.Unison = _elm.Unison || {};
   _elm.Unison.Var = _elm.Unison.Var || {};
   if (_elm.Unison.Var.values)
   return _elm.Unison.Var.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "Unison.Var",
   $Basics = Elm.Basics.make(_elm),
   $Elmz$Json$Decoder = Elm.Elmz.Json.Decoder.make(_elm),
   $Elmz$Json$Encoder = Elm.Elmz.Json.Encoder.make(_elm);
   var encode = function (i) {
      return $Elmz$Json$Encoder.number($Basics.toFloat(i));
   };
   var decode = $Elmz$Json$Decoder.$int;
   var succ = function (i) {
      return i + 1;
   };
   var z = 0;
   _elm.Unison.Var.values = {_op: _op
                            ,z: z
                            ,succ: succ
                            ,decode: decode
                            ,encode: encode};
...
Elm.Unison.Reference.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm),
   $Unison$Hash = Elm.Unison.Hash.make(_elm);
   var toString = function (r) {
      return function () {
         switch (r.ctor)
         {case "Builtin":
            return _L.append("builtin:",
              r._0);
            case "Derived":
            return _L.append("derived:",
              r._0);}
         _E.Case($moduleName,
   ...
   var decode = $Elmz$Json$Decoder.union$(function (t) {
      ...
      Derived,
      $Unison$Hash.decode) : $Elmz$Json$Decoder.fail(_L.append("unknown tag: ",
      t));
   });
   var fromString = function (s) {
      return A2($String.startsWith,
      "builtin:",
      s) ? $Maybe.Just(Builtin(A2($String.dropLeft,
      $String.length("builtin:"),
      s))) : A2($String.startsWith,
      "derived:",
      s) ? $Maybe.Just(Derived(A2($String.dropLeft,
      $String.length("derived:"),
      s))) : $Maybe.Nothing;
   };
...
Elm.Unison.Path.make = function (_elm) {
   ...
   var encodePath = $Elmz$Json$Encoder.array(encodeE);
   ...
   var decodeE = $Elmz$Json$Decoder.union$(function (t) {
      return _U.eq(t,
      "Fn") ? $Elmz$Json$Decoder.unit(Fn) : _U.eq(t,
      "Arg") ? $Elmz$Json$Decoder.unit(Arg) : _U.eq(t,
      "Body") ? $Elmz$Json$Decoder.unit(Body) : _U.eq(t,
      "Index") ? A2($Elmz$Json$Decoder.map,
      Index,
      $Elmz$Json$Decoder.$int) : _E.If($moduleName,
      "between lines 66 and 69");
   });
   var decodePath = $Elmz$Json$Decoder.array(decodeE);
...
Elm.Unison.Hash.make = function (_elm) {
   ...
   var decode = $Elmz$Json$Decoder.string;
...
Elm.Elmz.Json.Decoder.make = function (_elm) {
   ...
   $Set = Elm.Set.make(_elm),
   $String = Elm.String.make(_elm);
   var traverseMap = F2(function (f,
   m) {
      return function () {
         var strength = function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return A3($Either.either,
                    function ($) {
                       return $Either.Left($Basics.identity($));
                    },
                    function ($) {
                       return $Either.Right(F2(function (v0,
                       v1) {
                          return {ctor: "_Tuple2"
                                 ,_0: v0
                                 ,_1: v1};
                    ...
                    _v0._1);}
               _E.Case($moduleName,
               "on line 168, column 25 to 69");
            }();
         };
         var eithers = $List.map(strength)($Dict.toList(A2($Dict.map,
         f,
         m)));
         return function () {
            var _v4 = $Either.partition(eithers);
            switch (_v4.ctor)
            {case "_Tuple2":
               return $List.isEmpty(_v4._0) ? $Either.Right($Dict.fromList(_v4._1)) : $Either.Left($List.head(_v4._0));}
            _E.Case($moduleName,
   ...
   xs) {
      return function () {
         var _v7 = A2($List.drop,
         i,
         xs);
         switch (_v7.ctor)
         {case "::":
            return $Maybe.Just(_v7._0);
            case "[]":
            return $Maybe.Nothing;}
         _E.Case($moduleName,
   ...
   var index = F2(function (ind,
   v) {
      return function () {
         switch (v.ctor)
         {case "Array":
            return function () {
                 var msg = $Either.Left(_L.fromArray([_L.append("index not found: ",
                 _L.append($String.show(ind),
                 _L.append(" in ",
                 $String.show(v._0))))]));
                 return A3($Maybe.maybe,
                 msg,
                 $Either.Right,
                 A2(safeIndex,ind,v._0));
              }();}
         return $Either.Left(_L.fromArray([_L.append("cannot lookup index ",
         _L.append($String.show(ind),
         _L.append(" in: ",
         A2($Json.toString,"",v))))]));
      }();
   });
   var key = F2(function (k,v) {
      return function () {
         switch (v.ctor)
         {case "Object":
            return function () {
                 var msg = $Either.Left(_L.fromArray([_L.append("key not found: ",
                 _L.append(k,
                 _L.append(" in ",
                 $String.show(v._0))))]));
                 return A3($Maybe.maybe,
         ...
         return $Either.Left(_L.fromArray([_L.append("cannot lookup key ",
         _L.append(k,
         _L.append(" in: ",
         A2($Json.toString,"",v))))]));
      }();
      ...
      return function () {
         ...
         {case "Left":
            return function () {
                 ...
                 return $Either.Left(_v17._0);
              }();
            case "Right":
            return $Either.Right($Maybe.Just(_v17._0));}
         _E.Case($moduleName,
         "between lines 100 and 104");
      }();
   });
   var array = F2(function (p,v) {
      return function () {
         switch (v.ctor)
         {case "Array":
            return function () {
                 var _v23 = $Either.partition(A2($List.map,
                 p,
                 v._0));
                 switch (_v23.ctor)
                 {case "_Tuple2":
                    switch (_v23._0.ctor)
                      {case "::":
                         return $Either.Left(_v23._0._0);
                         case "[]":
                         return $Either.Right(_v23._1);}
                      break;}
                 _E.Case($moduleName,
                 "between lines 94 and 97");
              }();}
         return $Either.Left(_L.fromArray([_L.append("not an array: ",
         A2($Json.toString,"",v))]));
      }();
   });
   var object = F2(function (v,j) {
      return function () {
         switch (j.ctor)
         {case "Object":
            return A2(traverseMap,v,j._0);}
         return $Either.Left(_L.fromArray([_L.append("not an object: ",
         A2($Json.toString,"",j))]));
      }();
   });
   ...
   var lift3 = F5(function (f,
   a,
   b,
   c,
   v) {
      return function () {
         var _v30 = {ctor: "_Tuple3"
                    ,_0: a(v)
                    ,_1: b(v)
                    ,_2: c(v)};
         switch (_v30.ctor)
         {case "_Tuple3":
            switch (_v30._0.ctor)
              {case "Left":
                 return $Either.Left(_v30._0._0);}
              switch (_v30._1.ctor)
              {case "Left":
                 return $Either.Left(_v30._1._0);}
              switch (_v30._2.ctor)
              {case "Left":
                 return $Either.Left(_v30._2._0);}
              switch (_v30._0.ctor)
              {case "Right":
                 switch (_v30._1.ctor)
                   {case "Right":
   ...
   var lift2 = F4(function (f,
   a,
   b,
   v) {
      return function () {
         var _v40 = {ctor: "_Tuple2"
                    ,_0: a(v)
                    ,_1: b(v)};
         switch (_v40.ctor)
         {case "_Tuple2":
            switch (_v40._0.ctor)
              {case "Left":
                 return $Either.Left(_v40._0._0);}
              switch (_v40._1.ctor)
              {case "Left":
                 return $Either.Left(_v40._1._0);}
              switch (_v40._0.ctor)
              {case "Right":
                 switch (_v40._1.ctor)
                   {case "Right":
                      return $Either.Right(A2(f,
                        _v40._0._0,
                        _v40._1._0));}
                   break;}
              break;}
   ...
   var tuple2 = product2(F2(function (v0,
   v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   }));
   var map = F3(function (f,p,v) {
      return function () {
         var _v47 = p(v);
         switch (_v47.ctor)
         {case "Left":
            return $Either.Left(_v47._0);
            case "Right":
            return $Either.Right(f(_v47._0));}
         _E.Case($moduleName,
   ...
   var bind = F3(function (p,f,v) {
      return function () {
         var _v50 = p(v);
         switch (_v50.ctor)
         {case "Left":
            return $Either.Left(_v50._0);
            case "Right": return A2(f,
              _v50._0,
              v);}
         _E.Case($moduleName,
   ...
   v) {
      return function () {
         ...
         switch (_v53.ctor)
         {case "Left":
            return $Either.Left(A2($List._op["::"],
              msg,
              _v53._0));}
         return _v53;
      }();
   });
   var fail = F2(function (msg,v) {
      return $Either.Left(_L.fromArray([msg]));
   });
   ...
   function (v) {
      return function () {
         ...
         {case "String":
            return unit(v._0);}
         return fail(_L.append("not a string: ",
         A2($Json.toString,"",v)));
      }();
   });
   ...
   function (v) {
      return function () {
         switch (v.ctor)
         {case "Number":
            return unit($Basics.floor(v._0));}
         return fail(_L.append("not a number: ",
         A2($Json.toString,"",v)));
      }();
   });
   var number = A2(_op[">>="],
   ...
   var run = F2(function (p,v) {
      return function () {
         var _v65 = p(v);
         switch (_v65.ctor)
         {case "Left":
            return $Either.Left(A2($String.join,
              "\n",
              _v65._0));
            case "Right":
            return $Either.Right(_v65._0);}
         _E.Case($moduleName,
...
Elm.Elmz.Json.Encoder.make = function (_elm) {
   ...
   var product0 = function (_v0) {
      return function () {
         return $Json.Array(_L.fromArray([]));
      }();
   };
   ...
   p) {
      return function () {
         switch (p.ctor)
         {case "_Tuple5":
            return $Json.Array(_L.fromArray([ja(p._0)
                                            ,jb(p._1)
                                            ,jc(p._2)
                                            ,jd(p._3)
                                            ,je(p._4)]));}
   ...
   b,
   p) {
      return $Json.Array(_L.fromArray([a($Basics.fst(p))
                                      ,b($Basics.snd(p))]));
   });
   var object = function (v) {
      return function ($) {
         return $Json.Object($Dict.map(v)($));
      };
   };
   var emptyArray = function (_v17) {
      return function () {
         return $Json.Array(_L.fromArray([]));
      }();
   };
   var array = F2(function (f,vs) {
   ...
   var set = function (a) {
      return function ($) {
         return array(a)($Set.toList($));
      };
   };
   var dict = F2(function (k,v) {
      return function ($) {
         return array(A2(tuple2,
         k,
         v))($Dict.toList($));
      };
   });
   ...
   var $int = function (n) {
      return $Json.Number($Basics.toFloat(n));
   };
   var number = $Json.Number;
   var $null = function (_v19) {
      return function () {
         return $Json.Null;
      }();
   };
...
Elm.Unison.Styles.make = function (_elm) {
   ...
   var selection = F2(function (l,
   r) {
      return function () {
         var n = 1;
         var border = $Graphics$Element.opacity(0.8)(A4(outline$,
         asbestos,
         n,
         r.width,
         r.height));
         var highlight = $Graphics$Element.opacity(0.15)($Graphics$Element.color(asbestos)(A2($Graphics$Element.spacer,
         r.width,
         r.height)));
         var linestyle = function () {
            var d = $Graphics$Collage.dotted(wetAsphalt);
            return _U.replace([["width"
                               ,4.0]],
            d);
         }();
         return A4($Graphics$Element.container,
         $Elmz$Layout.widthOf(l),
         $Elmz$Layout.heightOf(l),
         A2($Graphics$Element.topLeftAt,
         $Graphics$Element.absolute(r.topLeft.x),
         $Graphics$Element.absolute(r.topLeft.y)),
         $Graphics$Element.layers(_L.fromArray([highlight
                                               ,border])));
      }();
   });
      ...
      return function () {
         ...
         return function () {
            ...
            {case "::": return function () {
                    ...
                    k,
                    $Graphics$Element.color(silver)(A2($Graphics$Element.spacer,
   ...
   var codeText = function (s) {
      return $Text.leftAligned(A2($Text.style,
      code,
      $Text.toText(s)));
   };
...
Elm.Elmz.Layout.make = function (_elm) {
         ...
         _v39) {
            return function () {
               ...
               {case "Layout": return _U.eq(ks,
                    by(_v39._2)) ? _L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: _v39._2
                                                 ,_1: A3(Region,
                                                 origin,
                                                 $Graphics$Element.widthOf(_v39._1),
                                                 $Graphics$Element.heightOf(_v39._1))}]) : $Basics.not(A2(prefixOf,
                    by(_v39._2),
                    ks)) ? _L.fromArray([]) : function () {
                       switch (_v39._0.ctor)
                       {case "Above":
                          return _L.append(A3(go,
                            origin,
                            ks,
                            _v39._0._0),
                            A3(go,
                            _U.replace([["y"
                                        ,origin.y + heightOf(_v39._0._0)]],
                            origin),
                            ks,
                            _v39._0._1));
                          case "Beside":
                          return _L.append(A3(go,
                            ...
                            A3(go,
                            _U.replace([["x"
                                        ,origin.x + widthOf(_v39._0._0)]],
                            origin),
                            ks,
                            _v39._0._1));
                          case "Container": return A3(go,
                            _U.replace([["x"
                                        ,origin.x + _v39._0._0.innerTopLeft.x]
                                       ,["y"
                                        ,origin.y + _v39._0._0.innerTopLeft.y]],
                            origin),
                            ks,
                            _v39._0._1);
                          case "Embed":
            ...
            return function () {
               ...
               {case "Layout":
                  return $Basics.not(A3(intersects,
                    origin,
                    $Graphics$Element.widthOf(_v55._1),
                    $Graphics$Element.heightOf(_v55._1))) ? _L.fromArray([]) : A2(distinctCons,
                    _v55._2,
                    function () {
                       switch (_v55._0.ctor)
                       {case "Above":
                          return _L.append(A2(go,
                            origin,
                            _v55._0._0),
                            A2(go,
                            _U.replace([["y"
                                        ,origin.y + heightOf(_v55._0._0)]],
                            origin),
                            _v55._0._1));
                          case "Beside":
                          return _L.append(A2(go,
                            ...
                            A2(go,
                            _U.replace([["x"
                                        ,origin.x + widthOf(_v55._0._0)]],
                            origin),
                            _v55._0._1));
                          case "Container": return A2(go,
                            _U.replace([["x"
                                        ,origin.x + _v55._0._0.innerTopLeft.x]
                                       ,["y"
                                        ,origin.y + _v55._0._0.innerTopLeft.y]],
                            origin),
                            _v55._0._1);
                          case "Embed":
                          return _L.fromArray([]);}
   ...
   r) {
      return function () {
         var done = function (_v68) {
            return function () {
               switch (_v68.ctor)
               {case "_Tuple3":
                  return A2($List._op["::"],
                    $List.reverse(_v68._1),
                    _v68._2);}
               _E.Case($moduleName,
               "on line 194, column 28 to 46");
            }();
         };
         var g = F2(function (_v73,
         _v74) {
            return function () {
               switch (_v74.ctor)
               {case "_Tuple3":
                  return function () {
                       switch (_v73.ctor)
                       {case "_Tuple2":
                          return _U.eq(_v73._0,
                            _v74._0) ? {ctor: "_Tuple3"
                                       ,_0: _v74._0
                                       ,_1: A2($List._op["::"],
                                       _v73._1,
                                       _v74._1)
                                       ,_2: _v74._2} : {ctor: "_Tuple3"
                                                       ,_0: _v73._0
                                                       ,_1: _L.fromArray([_v73._1])
                                                       ,_2: A2($List._op["::"],
                                                       $List.reverse(_v74._1),
                                                       _v74._2)};}
                       _E.Case($moduleName,
                       "between lines 192 and 193");
                    }();}
               _E.Case($moduleName,
               "between lines 192 and 193");
            }();
         ...
         return function () {
            var _v82 = $List.sortBy($Basics.fst)(A2($List.map,
            f,
            A2(at,l,r)));
            switch (_v82.ctor)
            {case "::":
...
Elm.Elmz.Signal.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var fromMaybe = $Signal.lift2($Elmz$Maybe.fromMaybe);
   ...
   a) {
      return $Signal.lift($List.reverse)(A4(foldpWhen,
      cond,
      F2(function (x,y) {
         return A2($List._op["::"],
         x,
      ...
      return function () {
         ...
         _v18) {
            return function () {
               ...
               {case "_Tuple2":
                  return function () {
                       var _v22 = A2(f,a,_v18._1);
                       switch (_v22.ctor)
                       {case "_Tuple2":
                          return {ctor: "_Tuple2"
                                 ,_0: $Maybe.Just(_v22._0)
                                 ,_1: _v22._1};}
                       _E.Case($moduleName,
   ...
   s) {
      return function () {
         var repeatable = A2($Signal.lift,
         f,
         s);
         var delayedRep = $Signal.lift($Basics.not)($Time.since(time)(A2($Signal.keepIf,
         $Basics.identity,
         false)(repeatable)));
   ...
   var quantize = F3(function (within,
   bin,
   s) {
      return function () {
         var f = F2(function (range,
         a) {
            return A2(within,
            a,
            range) ? $Maybe.Nothing : $Maybe.Just(a);
         });
         return A3($Signal.dropIf,
         $Maybe.isNothing,
         $Maybe.Nothing,
         A2($Signal._op["~"],
         A2($Signal._op["<~"],f,bin),
...
Elm.Elmz.Pattern = Elm.Elmz.Pattern || {};
Elm.Elmz.Pattern.make = function (_elm) {
   "use strict";
   _elm.Elmz = _elm.Elmz || {};
   _elm.Elmz.Pattern = _elm.Elmz.Pattern || {};
   if (_elm.Elmz.Pattern.values)
   return _elm.Elmz.Pattern.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Elmz.Pattern.values = {_op: _op
                              ,empty: empty
                              ,or: or};
   return _elm.Elmz.Pattern.values;
};Elm.Unison = Elm.Unison || {};
Elm.Unison.Stream = Elm.Unison.Stream || {};
Elm.Unison.Stream.make = function (_elm) {
   "use strict";
   _elm.Unison = _elm.Unison || {};
   _elm.Unison.Stream = _elm.Unison.Stream || {};
   if (_elm.Unison.Stream.values)
   return _elm.Unison.Stream.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "Unison.Stream",
   $Basics = Elm.Basics.make(_elm),
   $Maybe = Elm.Maybe.make(_elm);
   var maybeHead = function (s) {
      return function () {
         switch (s.ctor)
         {case "Cons":
            return $Maybe.Just(s._0({ctor: "_Tuple0"}));
            case "Empty":
            return $Maybe.Nothing;}
         _E.Case($moduleName,
   ...
   var unfold = F2(function (f,s) {
      return function () {
         ...
         function (_v8) {
            return function () {
               return A2(unfold,f,s$);
            }();
         });
      }();
   });
   var append = F2(function (l,r) {
      return function () {
         switch (l.ctor)
      ...
      return function () {
         ...
         {case "Cons":
            return function () {
                 ...
                 var hd = function (_v27) {
                    return function () {
                       return f(s._0({ctor: "_Tuple0"}));
                    }();
                 };
                 return A2(Cons,hd,tl);
              }();
   ...
   _elm.Unison.Stream.values = {_op: _op
                               ,Empty: Empty
                               ,Cons: Cons
                               ,fromList: fromList
                               ,unfold: unfold
