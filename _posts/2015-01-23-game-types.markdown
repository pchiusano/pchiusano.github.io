...
* There are rooms with computer terminals. But most of these terminals are just _geometry_. They look pretty, but you can't type on the keyboards or interact with them in any way. In one room, there are computers everywhere, but only one can you interact with to trigger some event.
...
So our coffee mug can be filled with liquid, emptied, or smashed. Each of these produces a collection of values _which have types_. We rely on the the type system to handle in a _fully generic way_ how these entities will interact with others.
...
But I view these as all [fun problems to solve](/2014-08-27/naysaying.html) rather than insurmountable difficulties. I have ideas about how to address concerns like this that perhaps I'll discuss in a later post.

In closing, I want lay out a vision for the experience of creating and then _playing_ richly interactive games organized using a framework like I describe:
